...
. . .
  ...
  - Relating these [4.2%]{.note} with [GDP]{.hi-orange}? (less people purchasing goods and services, or less than the amount had they been employed)
  
. . .

  - Relating these [4.2%]{.note} with those [employed]{.hi-slate}? (purchasing power lost, can lead to more unemployment)
  
. . .

  - And why should one [care]{.hi-pink} about unemployment? (away from potential; have information so can have policies to fix the problem)
...
[A]{.note}: The [civilian non-institutional population]{.note}.
  ...
  - Persons [16]{.note} years or older who do not live in institutions.
...
# Next time: Types of unemployment; wages