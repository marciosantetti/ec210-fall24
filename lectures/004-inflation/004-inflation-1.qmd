...
The [Consumer Price Index]{.note} (CPI) is a the most [popular]{.hi-red} inflation measure across media outlets.

. . .

<br>

  - Released by the [U.S. Bureau of Labor Statistics]{.hi-blue} (BLS), the CPI measures the average change over time in the prices paid by consumers for a representative basket of consumer goods and services.
